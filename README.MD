...
## Credits
Thanks for member of [Indonesian Mechanical Keyboard Group](https://discord.gg/t9yvV8y). Thank you so much [@herpiko](https://github.com/herpiko) for the inspiration and the thorough guide, [@dayatz](https://github.com//dayatz) for the double layer acrylic plate desain so I can reduce the cost. thanks [@sendz](https://github.com/sendz) for open sourcing his acrylic case design so I can learn to make my own version.